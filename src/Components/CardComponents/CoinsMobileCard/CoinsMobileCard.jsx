function CoinsMobileCard({ coin }) {
    return (
        <div className="flex flex-col list-none border-[2px] border-gray-700 h-full w-2/3 mx-auto text-center m-4 hover:scale-105 transition animate-ease-[cubic-bezier(0.25,0.1,0.25,1)] rounded-lg p-4" >
