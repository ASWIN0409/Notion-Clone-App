...
function BooksCard({book}) {
    ...
    return(
        <div className="border-[3px] mx-auto h-80 w-72 md:w-56 lg:w-60 dark:border-gray-800 dark:hover:border-white border-gray-400 p-4 text-center rounded-xl hover:scale-105 transition animate-ease-[cubic-bezier(0.25,0.1,0.25,1)] hover:border-gray-700">
